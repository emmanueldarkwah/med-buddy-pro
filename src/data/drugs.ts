...
export const drugs: Drug[] = [
  ...
  },
  {
    ...
    category: "Anticoagulant",
    uses: ["DVT/PE treatment and prevention", "Stroke prevention in atrial fibrillation", "Post-hip/knee surgery thromboprophylaxis"],
    mechanism: "Direct Factor Xa inhibitor, blocking thrombin generation and clot formation.",
    dosage: "10-20mg once or twice daily depending on indication",
    administration: { route: "Oral", timing: "With food for doses >10mg", withFood: true, reason: "Food increases absorption by 39% for higher doses." },
    sideEffects: ["Bleeding", "Anemia", "Nausea", "Back pain"],
    contraindications: ["Active bleeding", "Severe hepatic impairment", "Pregnancy"],
    interactions: [
      { drug: "Strong CYP3A4 inhibitors", severity: "severe", effect: "Increased rivaroxaban levels" },
      { drug: "Aspirin", severity: "moderate", effect: "Increased bleeding risk" }
    ],
    warnings: ["No routine monitoring needed", "Andexanet alfa for reversal", "Spinal hematoma risk with neuraxial anesthesia"],
    isDangerous: true,
    halfLife: "5-9 hours",
  ...
  },
  {
    ...
    class: "Direct Oral Anticoagulants (DOACs)",
    category: "Anticoagulant",
    uses: ["DVT/PE treatment", "Stroke prevention in AF", "VTE prophylaxis after hip/knee surgery"],
    mechanism: "Direct Factor Xa inhibitor, preventing conversion of prothrombin to thrombin.",
    dosage: "2.5-5mg twice daily",
    administration: { route: "Oral", timing: "Twice daily with or without food", withFood: false, reason: "Absorption not affected by food." },
    sideEffects: ["Bleeding", "Bruising", "Nausea", "Anemia"],
    contraindications: ["Active pathological bleeding", "Hepatic disease with coagulopathy"],
    interactions: [
      { drug: "Strong dual CYP3A4/P-gp inhibitors", severity: "severe", effect: "Double apixaban exposure" },
      { drug: "NSAIDs", severity: "moderate", effect: "Increased bleeding risk" }
    ],
    warnings: ["Lower bleeding rates than warfarin in trials", "Dose reduction criteria exist", "Andexanet alfa for reversal"],
    isDangerous: true,
    halfLife: "8-15 hours",
  ...
  },
  {
    ...
    uses: ["Osteoporosis treatment and prevention", "Paget's disease", "Glucocorticoid-induced osteoporosis"],
    mechanism: "Inhibits osteoclast-mediated bone resorption by binding to hydroxyapatite.",
    dosage: "70mg weekly or 10mg daily",
    administration: { route: "Oral", timing: "First thing in morning, 30 min before food/other meds", withFood: false, reason: "Must be taken fasting - food reduces absorption by 60%. Stay upright 30 min to prevent esophageal irritation." },
    sideEffects: ["Esophageal irritation", "Abdominal pain", "Musculoskeletal pain", "Osteonecrosis of jaw (rare)"],
    contraindications: ["Esophageal abnormalities", "Inability to stand/sit upright 30 min", "Hypocalcemia"],
    interactions: [
      { drug: "Calcium/antacids", severity: "moderate", effect: "Markedly reduce absorption" },
      { drug: "NSAIDs", severity: "moderate", effect: "Increased GI adverse effects" }
    ],
    warnings: ["Atypical femur fractures with long-term use", "Correct hypocalcemia first", "Dental exam before starting"],
    isDangerous: false,
    halfLife: "10+ years in bone",
    onsetOfAction: "3-6 months for bone density changes"
  },
  {
    id: "54",
    name: "Sildenafil",
    ...
    class: "Phosphodiesterase-5 Inhibitors",
    category: "Erectile Dysfunction/Pulmonary Hypertension",
    uses: ["Erectile dysfunction", "Pulmonary arterial hypertension"],
    mechanism: "Inhibits PDE5, increasing cGMP and causing smooth muscle relaxation and vasodilation.",
    dosage: "25-100mg as needed for ED; 20mg TID for PAH",
    administration: { route: "Oral", timing: "30-60 minutes before sexual activity", withFood: false, reason: "High-fat meal delays absorption. For PAH, space doses 4-6 hours apart." },
    sideEffects: ["Headache", "Flushing", "Dyspepsia", "Nasal congestion", "Visual disturbances"],
    contraindications: ["Concurrent nitrate use", "Recent stroke/MI", "Severe hypotension"],
    interactions: [
      { drug: "Nitrates", severity: "severe", effect: "Life-threatening hypotension - CONTRAINDICATED" },
      { drug: "Alpha-blockers", severity: "moderate", effect: "Additive hypotension" }
    ],
    warnings: ["Seek help for erection >4 hours", "Sudden vision/hearing loss - stop immediately", "No recreational use with poppers"],
    isDangerous: false,
    halfLife: "3-5 hours",
    onsetOfAction: "30-60 minutes"
  },
  {
    ...
    brandNames: ["Flomax", "Omnic"],
    class: "Alpha-1 Blockers",
    category: "Benign Prostatic Hyperplasia",
    uses: ["Benign prostatic hyperplasia (BPH)", "Ureteral stones (off-label)"],
    mechanism: "Selectively blocks alpha-1A receptors in prostate, bladder neck, and urethra, relaxing smooth muscle.",
    dosage: "0.4mg once daily",
    administration: { route: "Oral", timing: "30 minutes after same meal each day", withFood: true, reason: "Food improves absorption consistency. Take same time daily." },
    sideEffects: ["Dizziness", "Orthostatic hypotension", "Abnormal ejaculation", "Rhinitis", "Intraoperative floppy iris syndrome"],
    contraindications: ["Hypersensitivity to sulfonamides (some cross-reactivity)"],
    interactions: [
      { drug: "PDE5 inhibitors", severity: "moderate", effect: "Additive hypotension" },
      { drug: "Strong CYP3A4 inhibitors", severity: "moderate", effect: "Increased tamsulosin levels" }
    ],
    warnings: ["Inform ophthalmologist before cataract surgery", "First-dose orthostatic hypotension", "Priapism rare but possible"],
    isDangerous: false,
    halfLife: "9-15 hours",
    onsetOfAction: "4-8 hours"
  },
  {
    id: "56",
    name: "Finasteride",
    ...
    category: "BPH/Hair Loss",
    uses: ["Benign prostatic hyperplasia", "Male pattern hair loss"],
    mechanism: "Inhibits type II 5-alpha reductase, blocking conversion of testosterone to dihydrotestosterone (DHT).",
    dosage: "5mg daily for BPH; 1mg daily for hair loss",
    administration: { route: "Oral", timing: "Once daily", withFood: false, reason: "Can be taken with or without food." },
    sideEffects: ["Decreased libido", "Erectile dysfunction", "Ejaculation disorders", "Gynecomastia", "Depression"],
    contraindications: ["Women", "Children", "Pregnancy (teratogenic)"],
    interactions: [
      { drug: "No significant interactions", severity: "mild", effect: "Few drug interactions" }
    ],
    warnings: ["Women should not handle crushed tablets", "Decreases PSA by 50% - adjust interpretation", "Sexual side effects may persist after stopping"],
    isDangerous: false,
    halfLife: "6-8 hours",
    onsetOfAction: "3-6 months for BPH; 12 months for hair"
  },
  {
    id: "57",
    name: "Empagliflozin",
    ...
    category: "Antidiabetic",
    uses: ["Type 2 diabetes", "Heart failure (with or without diabetes)", "Chronic kidney disease"],
    mechanism: "Inhibits SGLT2 in proximal tubule, reducing glucose reabsorption and increasing urinary glucose excretion.",
    dosage: "10-25mg once daily",
    administration: { route: "Oral", timing: "Morning, with or without food", withFood: false, reason: "Morning dosing reduces nocturia from increased urination." },
    sideEffects: ["Genital mycotic infections", "UTIs", "Polyuria", "Hypotension", "Diabetic ketoacidosis"],
    contraindications: ["Type 1 diabetes", "Severe renal impairment (for glucose control)"],
    interactions: [
      { drug: "Diuretics", severity: "moderate", effect: "Increased risk of volume depletion" },
      { drug: "Insulin/sulfonylureas", severity: "moderate", effect: "May need dose reduction to avoid hypoglycemia" }
    ],
    warnings: ["Euglycemic DKA risk - hold perioperatively", "Fournier's gangrene (rare)", "Proven CV and renal benefits"],
    isDangerous: false,
    halfLife: "12.4 hours",
    onsetOfAction: "1-2 hours"
  },
  {
    ...
    uses: ["Type 2 diabetes", "Chronic weight management", "CV risk reduction in T2DM"],
    mechanism: "Activates GLP-1 receptors, enhancing glucose-dependent insulin secretion, reducing glucagon, slowing gastric emptying.",
    dosage: "0.6-1.8mg daily for diabetes; up to 3mg for weight loss",
    administration: { route: "Subcutaneous injection", timing: "Once daily at any time, same time each day", withFood: false, reason: "Inject in abdomen, thigh, or upper arm. Rotate injection sites." },
    ...
    interactions: [
      { drug: "Insulin/sulfonylureas", severity: "moderate", effect: "Increased hypoglycemia risk" },
      { drug: "Oral medications", severity: "mild", effect: "Delayed absorption due to slowed gastric emptying" }
    ],
    warnings: ["Black box warning for thyroid C-cell tumors in rodents", "Pancreatitis risk", "Start low and titrate slowly to reduce GI effects"],
    isDangerous: false,
    halfLife: "13 hours",
    onsetOfAction: "Days to weeks for glucose; weeks to months for weight"
  },
  {
    id: "59",
    name: "Semaglutide",
    ...
    class: "GLP-1 Receptor Agonists",
    category: "Antidiabetic/Weight Loss",
    uses: ["Type 2 diabetes", "Chronic weight management", "CV risk reduction"],
    mechanism: "Long-acting GLP-1 receptor agonist enhancing insulin secretion, suppressing glucagon, and promoting satiety.",
    dosage: "0.25-2mg weekly injection; 3-14mg daily oral",
    administration: { route: "Subcutaneous or Oral", timing: "Weekly injection any time; oral on empty stomach 30 min before food", withFood: false, reason: "Oral form has low bioavailability - must be taken fasting with minimal water." },
    sideEffects: ["Nausea", "Vomiting", "Diarrhea", "Abdominal pain", "Fatigue"],
    contraindications: ["MTC or MEN2", "Hypersensitivity"],
    interactions: [
      { drug: "Insulin/sulfonylureas", severity: "moderate", effect: "Hypoglycemia risk - may need dose reduction" }
    ],
    warnings: ["Most effective anti-obesity medication available", "Titrate slowly", "Thyroid tumor warning", "Gallbladder disease risk"],
    isDangerous: false,
    halfLife: "1 week (injectable)",
  ...
  },
  {
    ...
    uses: ["Nausea and vomiting", "Vertigo", "Migraine"],
    mechanism: "Blocks dopamine D2 receptors in the chemoreceptor trigger zone and vestibular system.",
    dosage: "5-10mg 3-4 times daily; 25mg rectally twice daily",
    administration: { route: "Oral, IM, IV, Rectal", timing: "Before meals and at bedtime", withFood: false, reason: "Taking before meals helps prevent nausea associated with eating." },
    sideEffects: ["Drowsiness", "Extrapyramidal symptoms", "Dry mouth", "Hypotension", "Neuroleptic malignant syndrome (rare)"],
    contraindications: ["Coma", "CNS depression", "Parkinson's disease", "Children under 2"],
    interactions: [
      { drug: "CNS depressants", severity: "moderate", effect: "Enhanced sedation" },
      { drug: "Anticholinergics", severity: "moderate", effect: "Increased anticholinergic effects" }
    ],
    warnings: ["Extrapyramidal effects especially in young adults", "Avoid in Parkinson's", "Not for chronic nausea in children"],
    isDangerous: false,
    halfLife: "6-8 hours",
  ...
  },
  {
    ...
    brandNames: ["Zofran", "Ondissolv"],
    class: "5-HT3 Antagonists",
    category: "Antiemetic",
    uses: ["Chemotherapy-induced nausea", "Radiation-induced nausea", "Postoperative nausea", "Gastroenteritis"],
    mechanism: "Blocks serotonin (5-HT3) receptors in the CTZ and vagal afferents.",
    dosage: "4-8mg every 8 hours; 16-24mg for chemo",
    administration: { route: "Oral, IV, IM", timing: "30 minutes before chemotherapy or as needed", withFood: false, reason: "Can be taken with or without food. ODT form dissolves on tongue." },
    ...
    interactions: [
      { drug: "QT prolonging drugs", severity: "moderate", effect: "Additive QT prolongation" },
      { drug: "Apomorphine", severity: "severe", effect: "Profound hypotension" }
    ],
    warnings: ["Monitor ECG in at-risk patients", "Single IV dose max 16mg", "Serotonin syndrome with serotonergic drugs"],
    isDangerous: false,
    halfLife: "3-6 hours",
  ...
  },
  {
    ...
    class: "H2 Receptor Antagonists",
    category: "Gastrointestinal",
    uses: ["GERD", "Peptic ulcer disease", "Zollinger-Ellison syndrome", "Heartburn"],
    mechanism: "Competitively inhibits histamine at H2 receptors on gastric parietal cells, reducing acid secretion.",
    dosage: "150mg twice daily or 300mg at bedtime",
    administration: { route: "Oral", timing: "With or without food", withFood: false, reason: "Can be taken with or without food. Bedtime dosing helps nocturnal acid." },
    sideEffects: ["Headache", "Dizziness", "Constipation", "Diarrhea"],
    contraindications: ["Known hypersensitivity", "Acute porphyria"],
    interactions: [
      { drug: "Ketoconazole", severity: "moderate", effect: "Reduced ketoconazole absorption" },
      { drug: "Warfarin", severity: "mild", effect: "May increase warfarin effect" }
    ],
    warnings: ["Recalled due to NDMA contamination concerns", "Use famotidine as alternative", "Check product availability"],
    isDangerous: false,
    halfLife: "2-3 hours",
    onsetOfAction: "1 hour"
  },
  {
    ...
    class: "H2 Receptor Antagonists",
    category: "Gastrointestinal",
    uses: ["GERD", "Peptic ulcer", "Heartburn", "Stress ulcer prophylaxis"],
    mechanism: "Reversibly blocks H2 receptors on parietal cells, inhibiting gastric acid secretion.",
    dosage: "20-40mg once or twice daily",
    administration: { route: "Oral, IV", timing: "Before meals or at bedtime", withFood: false, reason: "Can be taken with or without food." },
    sideEffects: ["Headache", "Dizziness", "Constipation", "Diarrhea"],
    contraindications: ["Hypersensitivity"],
    interactions: [
      { drug: "Atazanavir", severity: "moderate", effect: "Reduced HIV drug absorption" },
      { drug: "Ketoconazole", severity: "moderate", effect: "Reduced antifungal absorption" }
    ],
    warnings: ["Preferred H2 blocker since ranitidine withdrawal", "Adjust dose in renal impairment", "Less potent than PPIs"],
    isDangerous: false,
  ...
  },
  {
    ...
    dosage: "20-40mg once or twice daily",
    administration: { route: "Oral, IV", timing: "Before breakfast", withFood: false, reason: "Best taken on empty stomach before eating to maximize proton pump inhibition." },
    sideEffects: ["Headache", "Diarrhea", "Nausea", "Abdominal pain", "Fracture risk"],
    ...
    interactions: [
      ...
      { drug: "Clopidogrel", severity: "mild", effect: "Less interaction than omeprazole - often preferred" }
    ],
    warnings: ["Preferred with clopidogrel vs omeprazole", "Long-term risks similar to other PPIs", "C. diff risk"],
    isDangerous: false,
    halfLife: "1 hour",
    onsetOfAction: "2.5 hours"
  },
  {
    id: "65",
    name: "Rosuvastatin",
    ...
    class: "HMG-CoA Reductase Inhibitors (Statins)",
    category: "Antihyperlipidemic",
    uses: ["Hypercholesterolemia", "Hypertriglyceridemia", "CV risk reduction", "Slowing atherosclerosis"],
    mechanism: "Inhibits HMG-CoA reductase, the rate-limiting step in cholesterol synthesis.",
    dosage: "5-40mg once daily",
    administration: { route: "Oral", timing: "Any time of day", withFood: false, reason: "Can be taken at any time with or without food - long half-life allows flexibility." },
    sideEffects: ["Myalgia", "Headache", "Nausea", "Elevated liver enzymes", "Rhabdomyolysis (rare)"],
    contraindications: ["Active liver disease", "Pregnancy", "Breastfeeding"],
    interactions: [
      { drug: "Cyclosporine", severity: "severe", effect: "Greatly increased statin levels" },
      { drug: "Gemfibrozil", severity: "severe", effect: "Increased myopathy risk" },
      { drug: "Warfarin", severity: "moderate", effect: "Increased INR" }
    ],
    warnings: ["Most potent statin available", "Asian patients may need lower doses", "Monitor LFTs"],
    isDangerous: false,
    halfLife: "19 hours",
    onsetOfAction: "1-2 weeks"
  },
  {
    ...
    class: "Proton Pump Inhibitors",
    category: "Gastrointestinal",
    uses: ["GERD", "Erosive esophagitis", "H. pylori eradication", "NSAID ulcer prevention"],
    mechanism: "S-isomer of omeprazole; irreversibly inhibits gastric proton pump.",
    dosage: "20-40mg once or twice daily",
    administration: { route: "Oral, IV", timing: "At least 1 hour before meals", withFood: false, reason: "Food reduces plasma concentrations. Best efficacy when taken before eating." },
    sideEffects: ["Headache", "Diarrhea", "Nausea", "Flatulence", "Abdominal pain"],
    contraindications: ["PPI hypersensitivity", "Rilpivirine use"],
    interactions: [
      { drug: "Clopidogrel", severity: "moderate", effect: "Reduces clopidogrel activation" },
      { drug: "Methotrexate", severity: "moderate", effect: "Increased methotrexate toxicity" }
    ],
    warnings: ["S-isomer of omeprazole with similar efficacy", "Same long-term risks as other PPIs", "Interacts with clopidogrel"],
    isDangerous: false,
    halfLife: "1-1.5 hours",
    onsetOfAction: "1-2 hours"
  },
  {
    ...
    category: "Psychiatric",
    uses: ["Major depressive disorder", "Generalized anxiety disorder", "Social anxiety", "Panic disorder", "Neuropathic pain"],
    mechanism: "Inhibits reuptake of serotonin and norepinephrine, and weakly inhibits dopamine reuptake.",
    dosage: "75-375mg daily in divided doses or once daily (XR)",
    administration: { route: "Oral", timing: "With food", withFood: true, reason: "Food reduces GI side effects. XR should be taken at same time daily." },
    ...
    interactions: [
      { drug: "MAO inhibitors", severity: "severe", effect: "Serotonin syndrome - contraindicated" },
      { drug: "Tramadol", severity: "severe", effect: "Serotonin syndrome risk" },
      { drug: "Triptans", severity: "moderate", effect: "Serotonin syndrome risk" }
    ],
    warnings: ["Discontinuation syndrome - taper slowly", "Monitor BP at higher doses", "Suicidal ideation in young adults"],
    isDangerous: false,
  ...
  },
  {
    ...
    class: "Serotonin-Norepinephrine Reuptake Inhibitors (SNRIs)",
    category: "Psychiatric",
    uses: ["Major depressive disorder", "Generalized anxiety disorder", "Diabetic neuropathy", "Fibromyalgia", "Chronic musculoskeletal pain"],
    mechanism: "Potently inhibits serotonin and norepinephrine reuptake.",
    dosage: "30-120mg once daily",
    administration: { route: "Oral", timing: "With or without food", withFood: false, reason: "Can be taken with or without food. Do not crush or chew." },
    sideEffects: ["Nausea", "Dry mouth", "Constipation", "Fatigue", "Decreased appetite", "Sexual dysfunction"],
    contraindications: ["MAO inhibitors within 14 days", "Uncontrolled narrow-angle glaucoma", "Severe hepatic impairment"],
    interactions: [
      { drug: "MAO inhibitors", severity: "severe", effect: "Serotonin syndrome" },
      { drug: "CYP1A2 inhibitors", severity: "moderate", effect: "Increased duloxetine levels" },
      { drug: "Thioridazine", severity: "severe", effect: "Increased thioridazine levels - arrhythmia risk" }
    ],
    warnings: ["Hepatotoxicity - avoid in liver disease", "Avoid in heavy alcohol use", "Taper to discontinue"],
    isDangerous: false,
    halfLife: "12 hours",
  ...
  },
  {
    ...
    brandNames: ["Remeron"],
    class: "Noradrenergic and Specific Serotonergic Antidepressants (NaSSAs)",
    category: "Psychiatric",
    uses: ["Major depressive disorder", "Insomnia (off-label)", "Appetite stimulation (off-label)"],
    mechanism: "Blocks alpha-2 adrenergic auto/heteroreceptors and 5-HT2/5-HT3 receptors, enhancing noradrenergic and serotonergic transmission.",
    dosage: "15-45mg at bedtime",
    administration: { route: "Oral", timing: "At bedtime", withFood: false, reason: "Sedation makes bedtime dosing ideal. Can help with insomnia." },
    ...
    interactions: [
      { drug: "MAO inhibitors", severity: "severe", effect: "Serotonin syndrome" },
      { drug: "CNS depressants", severity: "moderate", effect: "Enhanced sedation" },
      { drug: "CYP3A4 inducers", severity: "moderate", effect: "Decreased mirtazapine levels" }
    ],
    warnings: ["Paradoxically more sedating at lower doses", "Good for underweight depressed patients", "Agranulocytosis rare but serious"],
    isDangerous: false,
  ...
  },
  {
    ...
    class: "Norepinephrine-Dopamine Reuptake Inhibitors (NDRIs)",
    category: "Psychiatric",
    uses: ["Major depressive disorder", "Seasonal affective disorder", "Smoking cessation", "ADHD (off-label)"],
    mechanism: "Inhibits reuptake of norepinephrine and dopamine. No significant serotonergic activity.",
    dosage: "150-450mg daily",
    administration: { route: "Oral", timing: "Morning or divided doses; avoid bedtime", withFood: false, reason: "Can cause insomnia - avoid evening dosing. SR/XL forms should not be crushed." },
    sideEffects: ["Insomnia", "Dry mouth", "Headache", "Nausea", "Agitation", "Seizures (dose-related)"],
    contraindications: ["Seizure disorder", "Bulimia/anorexia", "MAO inhibitor use", "Abrupt alcohol/benzo withdrawal"],
    interactions: [
      { drug: "MAO inhibitors", severity: "severe", effect: "Hypertensive crisis" },
      { drug: "Drugs lowering seizure threshold", severity: "moderate", effect: "Increased seizure risk" }
    ],
    warnings: ["Does not cause sexual dysfunction or weight gain", "Dose-dependent seizure risk", "Good for patients concerned about sexual side effects"],
    isDangerous: false,
    halfLife: "21 hours",
    onsetOfAction: "1-4 weeks"
  },
  {
    ...
    class: "Serotonin Antagonist and Reuptake Inhibitors (SARIs)",
    category: "Psychiatric",
    uses: ["Major depressive disorder", "Insomnia (most common use)", "Anxiety"],
    mechanism: "Inhibits serotonin reuptake and blocks 5-HT2A receptors; also blocks H1 and alpha-1 receptors.",
    dosage: "50-400mg daily; 25-100mg for insomnia",
    administration: { route: "Oral", timing: "At bedtime for insomnia; with food for depression", withFood: true, reason: "Food reduces dizziness and lightheadedness. Bedtime dosing leverages sedation." },
    sideEffects: ["Sedation", "Orthostatic hypotension", "Dry mouth", "Priapism (rare)", "Cardiac arrhythmias"],
    contraindications: ["MAO inhibitors within 14 days", "Recovery period after MI"],
    interactions: [
      { drug: "MAO inhibitors", severity: "severe", effect: "Serotonin syndrome" },
      { drug: "CYP3A4 inhibitors", severity: "moderate", effect: "Increased trazodone levels" },
      { drug: "Digoxin", severity: "moderate", effect: "Increased digoxin levels" }
    ],
    warnings: ["Priapism - seek immediate help for prolonged erection", "Often used off-label for insomnia at low doses", "Less effective than SSRIs for depression"],
    isDangerous: false,
    halfLife: "5-9 hours",
    onsetOfAction: "1-2 weeks"
  },
  {
    ...
    uses: ["Anxiety", "Pruritus", "Sedation", "Nausea/vomiting", "Allergic reactions"],
    mechanism: "Blocks H1 histamine receptors centrally and peripherally; also has anticholinergic and sedative properties.",
    dosage: "25-100mg 3-4 times daily",
    administration: { route: "Oral, IM", timing: "With or without food", withFood: false, reason: "Can be taken with or without food." },
    sideEffects: ["Sedation", "Dry mouth", "Constipation", "Blurred vision", "Urinary retention"],
    contraindications: ["Early pregnancy", "QT prolongation", "Breastfeeding"],
    interactions: [
      { drug: "CNS depressants", severity: "moderate", effect: "Enhanced sedation" },
      { drug: "Anticholinergics", severity: "moderate", effect: "Additive anticholinergic effects" },
      { drug: "QT prolonging drugs", severity: "moderate", effect: "Increased arrhythmia risk" }
    ],
    warnings: ["Non-addictive anxiolytic option", "QT prolongation at high doses", "Avoid in elderly due to anticholinergic burden"],
    isDangerous: false,
  ...
  },
  {
    ...
    class: "Azapirones",
    category: "Anxiolytic",
    uses: ["Generalized anxiety disorder", "Augmentation of antidepressants"],
    mechanism: "Partial agonist at 5-HT1A receptors; also has weak D2 dopamine receptor activity.",
    dosage: "15-60mg daily in divided doses",
    administration: { route: "Oral", timing: "Two or three times daily, consistently with or without food", withFood: false, reason: "Food increases absorption. Take consistently with regard to food." },
    sideEffects: ["Dizziness", "Headache", "Nausea", "Nervousness", "Lightheadedness"],
    contraindications: ["MAO inhibitor use within 14 days"],
    interactions: [
      { drug: "MAO inhibitors", severity: "severe", effect: "Hypertensive crisis" },
      { drug: "CYP3A4 inhibitors", severity: "moderate", effect: "Increased buspirone levels" },
      { drug: "Grapefruit juice", severity: "moderate", effect: "Increased buspirone levels" }
    ],
    warnings: ["No abuse potential - not controlled", "Takes 2-4 weeks for effect", "Does not work PRN like benzodiazepines"],
    isDangerous: false,
    halfLife: "2-3 hours",
    onsetOfAction: "2-4 weeks"
  },
  {
    ...
    uses: ["Hypertension", "Angina", "Arrhythmias", "Migraine prevention", "Essential tremor", "Performance anxiety", "Thyrotoxicosis"],
    mechanism: "Non-selectively blocks beta-1 and beta-2 adrenergic receptors.",
    dosage: "40-320mg daily in divided doses",
    administration: { route: "Oral, IV", timing: "Two to four times daily; LA forms once daily", withFood: true, reason: "Food increases bioavailability. Consistent timing important." },
    ...
    interactions: [
      { drug: "Calcium channel blockers", severity: "moderate", effect: "Additive cardiac depression" },
      { drug: "Insulin", severity: "moderate", effect: "Masks hypoglycemia symptoms" },
      { drug: "Clonidine", severity: "moderate", effect: "Rebound hypertension if clonidine stopped" }
    ],
    warnings: ["Avoid abrupt discontinuation", "Contraindicated in asthma", "Masks hypoglycemia warning signs"],
    isDangerous: false,
    halfLife: "3-6 hours",
    onsetOfAction: "1-2 hours"
  },
  {
    ...
    mechanism: "Selectively blocks beta-1 adrenergic receptors in heart, reducing heart rate and contractility.",
    dosage: "25-100mg once daily",
    administration: { route: "Oral", timing: "Once daily, morning", withFood: false, reason: "Can be taken with or without food." },
    sideEffects: ["Bradycardia", "Fatigue", "Cold extremities", "Dizziness", "Depression"],
    contraindications: ["Severe bradycardia", "Heart block", "Cardiogenic shock", "Sick sinus syndrome"],
    interactions: [
      { drug: "Verapamil/diltiazem", severity: "moderate", effect: "Additive AV block and bradycardia" },
      { drug: "Clonidine", severity: "moderate", effect: "Withdrawal rebound if clonidine stopped first" }
    ],
    warnings: ["Beta-1 selective but selectivity diminishes at higher doses", "Renal dose adjustment needed", "Do not stop abruptly"],
    isDangerous: false,
    halfLife: "6-7 hours",
    onsetOfAction: "1-2 hours"
  },
  {
    ...
    brandNames: ["Coreg"],
    class: "Non-selective Beta Blockers with Alpha-1 Blockade",
    category: "Cardiovascular",
    uses: ["Heart failure", "Hypertension", "Post-MI left ventricular dysfunction"],
    mechanism: "Blocks beta-1, beta-2, and alpha-1 adrenergic receptors, reducing heart rate and causing vasodilation.",
    dosage: "3.125-25mg twice daily",
    administration: { route: "Oral", timing: "With food twice daily", withFood: true, reason: "Food slows absorption and reduces orthostatic hypotension." },
    sideEffects: ["Dizziness", "Fatigue", "Hypotension", "Bradycardia", "Weight gain", "Diarrhea"],
    contraindications: ["Bronchospastic disease", "Severe bradycardia", "Severe hepatic impairment", "Decompensated heart failure requiring IV inotropes"],
    interactions: [
      { drug: "Digoxin", severity: "moderate", effect: "Increased digoxin levels" },
      { drug: "CYP2D6 inhibitors", severity: "moderate", effect: "Increased carvedilol levels" }
    ],
    warnings: ["Start low, go slow in heart failure", "Evidence-based for heart failure mortality reduction", "May worsen heart failure initially"],
    isDangerous: false,
    halfLife: "7-10 hours",
    onsetOfAction: "1-2 hours"
  },
  {
    ...
    class: "Potassium-Sparing Diuretics (Aldosterone Antagonist)",
    category: "Diuretic/Cardiovascular",
    uses: ["Heart failure", "Ascites in cirrhosis", "Hypertension", "Primary hyperaldosteronism", "Acne/hirsutism in women (off-label)"],
    mechanism: "Competitive aldosterone receptor antagonist, preventing sodium reabsorption and potassium excretion.",
    dosage: "25-400mg daily",
    administration: { route: "Oral", timing: "With food", withFood: true, reason: "Food increases bioavailability." },
    sideEffects: ["Hyperkalemia", "Gynecomastia", "Breast tenderness", "Menstrual irregularities", "GI upset"],
    contraindications: ["Hyperkalemia", "Anuria", "Acute renal insufficiency", "Addison's disease"],
    interactions: [
      { drug: "ACE inhibitors/ARBs", severity: "moderate", effect: "Increased hyperkalemia risk" },
      { drug: "Potassium supplements", severity: "severe", effect: "Dangerous hyperkalemia" },
      { drug: "NSAIDs", severity: "moderate", effect: "Reduced diuretic effect and hyperkalemia" }
    ],
    warnings: ["Monitor potassium closely", "Gynecomastia more common with higher doses", "Proven mortality benefit in heart failure"],
    isDangerous: false,
    halfLife: "1-2 hours (active metabolite 14-17 hours)",
    onsetOfAction: "24-48 hours (peak 48-72 hours)"
  },
  {
    id: "78",
    name: "Montelukast",
    ...
    mechanism: "Blocks cysteinyl leukotriene receptors, reducing bronchoconstriction, mucus secretion, and inflammation.",
    dosage: "10mg once daily for adults; 4-5mg for children",
    administration: { route: "Oral", timing: "Evening for asthma; any time for allergies", withFood: false, reason: "Can be taken with or without food. Evening dosing may optimize asthma control." },
    sideEffects: ["Headache", "Abdominal pain", "Fatigue", "Neuropsychiatric events"],
    contraindications: ["Hypersensitivity"],
    interactions: [
      { drug: "Phenobarbital", severity: "moderate", effect: "Decreased montelukast levels" },
      { drug: "CYP3A4 inducers", severity: "moderate", effect: "Reduced efficacy" }
    ],
    warnings: ["Black box warning for neuropsychiatric events including suicidal ideation", "Not for acute asthma attacks", "Consider benefit/risk"],
    isDangerous: false,
    halfLife: "2.7-5.5 hours",
  ...
  },
  {
    ...
    brandNames: ["Spiriva"],
    class: "Long-Acting Muscarinic Antagonists (LAMAs)",
    category: "Respiratory",
    uses: ["COPD maintenance", "Asthma (add-on therapy)"],
    mechanism: "Blocks muscarinic M3 receptors in airways, causing bronchodilation.",
    dosage: "18mcg inhaled once daily (HandiHaler); 2.5mcg two puffs once daily (Respimat)",
    administration: { route: "Inhalation", timing: "Once daily at same time", withFood: false, reason: "Proper inhaler technique essential. Once-daily dosing improves adherence." },
    sideEffects: ["Dry mouth", "Constipation", "Urinary retention", "Blurred vision", "Pharyngitis"],
    contraindications: ["Hypersensitivity to atropine or derivatives"],
    interactions: [
      { drug: "Other anticholinergics", severity: "moderate", effect: "Additive anticholinergic effects" }
    ],
    warnings: ["Not for acute bronchospasm", "Teach proper inhaler technique", "Urinary retention in BPH patients"],
    isDangerous: false,
    halfLife: "25-45 hours",
    onsetOfAction: "30 minutes"
  },
  {
    id: "80",
    ...
    brandNames: ["Advair", "Seretide"],
    class: "Inhaled Corticosteroid + Long-Acting Beta Agonist (ICS/LABA)",
    category: "Respiratory",
    uses: ["Asthma", "COPD maintenance"],
    mechanism: "Fluticasone reduces inflammation; salmeterol causes prolonged bronchodilation via beta-2 receptor stimulation.",
    dosage: "1-2 inhalations twice daily (various strengths)",
    administration: { route: "Inhalation", timing: "Morning and evening, 12 hours apart", withFood: false, reason: "Rinse mouth after use to prevent oral candidiasis." },
    sideEffects: ["Oral thrush", "Hoarseness", "Headache", "Pharyngitis", "Adrenal suppression (high doses)"],
    contraindications: ["Status asthmaticus", "Hypersensitivity", "Primary treatment of acute asthma"],
    interactions: [
      { drug: "Strong CYP3A4 inhibitors", severity: "moderate", effect: "Increased fluticasone levels and systemic effects" },
      { drug: "Beta-blockers", severity: "moderate", effect: "May reduce salmeterol effectiveness" }
    ],
    warnings: ["Not for acute attacks", "Rinse mouth after use", "Do not exceed recommended dose", "LABA should not be used alone for asthma"],
    isDangerous: false,
    halfLife: "Fluticasone 8h; Salmeterol 5.5h",
    onsetOfAction: "30 minutes (salmeterol); days to weeks (fluticasone)"
  }
];
...
export const drugClasses = [
  ...
  { name: "Phenothiazines", category: "Antiemetic", count: 1 },
  { name: "Xanthine Oxidase Inhibitors", category: "Antigout", count: 1 },
  { name: "Bisphosphonates", category: "Bone Health", count: 1 },
  { name: "Direct Oral Anticoagulants", category: "Anticoagulant", count: 1 },
  { name: "Phosphodiesterase-5 Inhibitors", category: "Erectile Dysfunction", count: 1 },
  { name: "Alpha-1 Blockers", category: "BPH/Antihypertensive", count: 1 },
  { name: "5-Alpha Reductase Inhibitors", category: "BPH", count: 1 },
  { name: "TNF Inhibitors", category: "Immunosuppressant", count: 1 },
  { name: "Incretin Mimetics", category: "Antidiabetic", count: 1 },
  { name: "SGLT2 Inhibitors", category: "Antidiabetic", count: 1 },
];
